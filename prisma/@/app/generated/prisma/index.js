...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\Dispatcher\\OneDrive\\Рабочий стол\\Frontent Sardor\\Next JS\\FullStack\\threads\\prisma\\@\\app\\generated\\prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "C:\\Users\\Dispatcher\\OneDrive\\Рабочий стол\\Frontent Sardor\\Next JS\\FullStack\\threads\\prisma\\schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": "../../../../../.env",
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        ...
        "value": "postgresql://postgres:Sardor 2010@localhost:5432/blognext?schema=public"
      }
    }
  },
  "inlineSchema": "generator client {\n  provider = \"prisma-client-js\"\n  output   = \"@/app/generated/prisma\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel User {\n  id    Int     @id @default(autoincrement())\n  email String  @unique\n  name  String?\n  posts Post[]\n}\n\nmodel Post {\n  id        Int     @id @default(autoincrement())\n  title     String\n  content   String?\n  published Boolean @default(false)\n  authorId  Int\n  author    User    @relation(fields: [authorId], references: [id])\n}\n",
  "inlineSchemaHash": "85abf0cd4ad51be36212670614556c82e8abfb2ea35cb7eb7a795fa9b93cc8c2",
  "copyEngine": true
}
